...
class Simulador:
    def __init__(self, productos):
        self.productos = productos  # Cambiamos de una máquina a una lista de productos
        self.maquina = None  # Esto se inicializará cuando se simule

    def establecer_maquina(self, maquina):
        self.maquina = maquina  # Método para establecer la máquina a simular

    def simular(self):
        tiempo_total = 0
        pasos = ListaEnlazada()  # Usar lista enlazada para almacenar los pasos de la simulación

        for producto in self.productos:  # Iterar sobre los productos a simular
    ...
    def obtener_reporte(self):
        """
        Método para obtener un reporte de los productos y sus tiempos de ensamblaje.
        """
        reportes = ListaEnlazada()  # Lista enlazada para almacenar reportes de productos
        for producto in self.productos:
            reportes.insertar(f"Producto: {producto.nombre}, Tiempo Total: {producto.tiempo_total} segundos")
        return reportes
